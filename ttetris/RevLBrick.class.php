    ...
    private static $BRICKDEF = array(
       self::ROTATION_0DEG => array(
        ...
        self::ROTATION_90DEG => array(
            array(3, 2),
            array(
                array(Matrix::CELL_SET,     Matrix::CELL_SET,     Matrix::CELL_SET),
                array(Matrix::CELL_NOT_SET, Matrix::CELL_NOT_SET, Matrix::CELL_SET)
            )
        ),
        ...
        self::ROTATION_270DEG => array(
            array(3, 2),
            array(
                array(Matrix::CELL_SET, Matrix::CELL_NOT_SET, Matrix::CELL_NOT_SET),
                array(Matrix::CELL_SET, Matrix::CELL_SET,     Matrix::CELL_SET)
            )
        ),
    );
